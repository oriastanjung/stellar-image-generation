...
openssl x509 -req -extfile <(printf "subjectAltName=DNS:${SERVER_CN},IP:0.0.0.0") -passin pass:1111 -sha256 -days 1095 -in server.csr -CA ca.crt -CAkey ca.key -set_serial 01 -out server.crt 
